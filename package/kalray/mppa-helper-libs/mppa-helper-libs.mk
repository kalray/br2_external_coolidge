...
MPPA_HELPER_LIBS_COS_OPTS =  $(MPPA_HELPER_LIBS_OPTS)
...
define MPPA_HELPER_LIBS_BUILD_CMDS
	...
	$(TARGET_MAKE_ENV) $(MAKE) $(MPPA_HELPER_LIBS_COS_OPTS) -C $(@D)/cos/link_monitor
	$(TARGET_MAKE_ENV) $(MAKE) $(MPPA_HELPER_LIBS_COS_OPTS) -C $(@D)/cos/watchdog
	$(TARGET_MAKE_ENV) $(MAKE) $(MPPA_HELPER_LIBS_COS_OPTS) -C $(@D)/cos/dpdk_notif
...
define MPPA_HELPER_LIBS_INSTALL_STAGING_CMDS
	 ...
	 $(TARGET_MAKE_ENV) $(MAKE) $(MPPA_HELPER_LIBS_COS_OPTS) -C $(@D)/cos/link_monitor install
	 $(TARGET_MAKE_ENV) $(MAKE) $(MPPA_HELPER_LIBS_COS_OPTS) -C $(@D)/cos/watchdog install
	 $(TARGET_MAKE_ENV) $(MAKE) $(MPPA_HELPER_LIBS_COS_OPTS) -C $(@D)/cos/dpdk_notif install
endef
