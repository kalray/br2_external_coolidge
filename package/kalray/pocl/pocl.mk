...
POCL_CONF_OPTS = -DINSTALL_OPENCL_HEADERS:BOOL=ON -DCMAKE_VERBOSE_MAKEFILE:BOOL=ON -DDEFAULT_ENABLE_ICD:BOOL=OFF -DHOST_CPU_CACHELINE_SIZE=64 -DENABLE_LLVM:BOOL=OFF -DENABLE_TESTS:BOOL=OFF -DENABLE_POCLCC:BOOL=OFF -DENABLE_EXAMPLES:BOOL=OFF -DENABLE_LOADABLE_DRIVERS:BOOL=OFF -DCMAKE_C_FLAGS="-DBUILD_MPPA $(POCL_BUILD_OPTIMIZE)" -DENABLE_HOST_CPU_DEVICES:BOOL=OFF
