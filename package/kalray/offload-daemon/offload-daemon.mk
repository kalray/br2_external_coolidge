...
OFFLOAD_DAEMON_OPTS = TARGET=cluster
OFFLOAD_DAEMON_OPTS += KALRAY_TOOLCHAIN_DIR=$(BR2_EXTERNAL_KVX_PATH)/support/kalray/
...
OFFLOAD_DAEMON_DEPENDENCIES = mppa-rproc libevent libdaemon json-c
